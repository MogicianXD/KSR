nohup python -u run_KSR.py --data m15cat --type A --epochs 300 --lr 0.002 --cuda 4 --pretrain > m15A2 2>&1 &
nohup python -u run_KSR.py --data m15cat --type B --epochs 300 --lr 0.002 --cuda 2 --pretrain > m15B2 2>&1 &
